...
static const Operator operators[OP_CNT] = {
    ...
    {"!",      1,  NOT,      my_not,    MATH_TYPE,   2, 3, {3, 1, 1}},
    {"+",      1,  ADD,      my_add,    MATH_TYPE,   0, 4, {3, 2, 0, 1}},
    {"-",      1,  SUB,      my_sub,    MATH_TYPE,   0, 4, {3, 2, 0, 0}},
    {"*",      1,  MUL,      my_mul,    MATH_TYPE,   1, 4, {3, 2, 1, 0}},
    {"/",      1,  DIV,      my_div,    MATH_TYPE,   1, 4, {3, 2, 1, 2}},
    {"%",      1,  MOD,      my_mod,    MATH_TYPE,   1, 4, {3, 2, 1, 3}},
    {"&",      1,  AND,      my_and,    MATH_TYPE,   0, 4, {3, 1, 0, 3}},
    {"|",      1,  OR ,      my_or,     MATH_TYPE,   1, 4, {3, 1, 0, 2}},
    {"<",      1,  LESS,     my_less,   MATH_TYPE,   0, 4, {3, 0, 0, 2}},
    {"<=",     2,  LEQ,      my_leq,    MATH_TYPE,   0, 4, {3, 0, 0, 3}},
    {">",      1,  GRTR,     my_grtr,   MATH_TYPE,   0, 4, {3, 0, 0, 0}},
    {">=",     2,  GEQ,      my_geq,    MATH_TYPE,   0, 4, {3, 0, 0, 1}},
    {"!=",     2,  NEQ,      my_neq,    MATH_TYPE,   0, 3, {3, 0, 2}},
    {"==",     2,  EQ,       my_eq,     MATH_TYPE,   0, 3, {3, 0, 1}},
    {"=",      1,  ASSIGN,   nullptr,   MATH_TYPE,   0, 3, {3, 3, 2}},
    {",",      1,  COMMA,    my_com,    MATH_TYPE,   0, 3, {2, 3, 0}},
    {"(",      1,  LEFT_B,   nullptr,   MATH_TYPE,   0, 3, {2, 0, 1}},
    {")",      1,  RIGHT_B,  nullptr,   MATH_TYPE,   0, 3, {2, 0, 0}},
    {"{",      1,  LEFT_BL,  nullptr,   OP_TYPE,     0, 3, {2, 1, 3}},
    {"}",      1,  RIGHT_BL, nullptr,   OP_TYPE,     0, 3, {2, 1, 0}},
    {"def",    3,  DEF_FUNC, nullptr,   OP_TYPE,     0, 2, {0, 3}},
    {"var",    3,  DEF_VAR,  nullptr,   OP_TYPE,     0, 2, {0, 2}},
    {"CALL",   4,  CALL,     nullptr,   OP_TYPE,     0},
    {"return", 6,  RET,      nullptr,   OP_TYPE,     0, 2, {1, 0}},
    {"print",  5,  PRNT,     nullptr,   OP_TYPE,     0, 3, {1, 3, 0}},
